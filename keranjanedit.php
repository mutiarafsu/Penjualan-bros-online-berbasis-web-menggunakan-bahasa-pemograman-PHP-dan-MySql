...
for($i=1; $i<=$jml_data; $i++){
  ...
  if($jumlah[$i] > $stok){
	echo "<b>STOK TIDAK CUKUP</b> <br> Anda ingin membeli <b>$jumlah[$i]</b> unit <b>$rpr[namaproduk]</b> dari <b>$stok</b> unit yang tersedia <br> Silahkan Tekan Tombol <b>Pesan</b> untuk melakukan pemesanan";
  }else{
...
echo "<META HTTP-EQUIV='Refresh' Content='5; URL=?p=keranjangbelanja&ida=$_POST[ida]'>";
?>
